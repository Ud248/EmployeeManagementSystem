    ...
    <body>
        <div class="content">
            <div style="padding: 20px 20px 0px 20px">
                ...
                <div class="action-btn">
                    ...
                    <button class="new-employee-btn" onclick="openPopup('insertProjectPopup', null, event)">
        ...
        <div id="insertProjectPopup" class="popup">
            <div class="popup-content">
                <span class="close-btn" onclick="closePopup('insertProjectPopup')">&times;</span>
                <iframe id="insertProjectFrame"></iframe>
            </div>
        </div>
        <div id="viewProjectPopup" class="popup">
            <div class="popup-content">
                <span class="close-btn" onclick="closePopup('viewProjectPopup')">&times;</span>
                <iframe id="viewProjectFrame"></iframe>
            </div>
        </div>
        <script>
            function openPopup(id, projectId = null, event) {
